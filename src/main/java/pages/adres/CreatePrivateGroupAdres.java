...
public class CreatePrivateGroupAdres extends BasePage {
    public CreatePrivateGroupAdres(WebDriver driver) {
        super(driver);
    }
    ...
    By clickTabAdress = By.cssSelector("#root > div > section > aside > div > ul > li.ant-menu-item.ant-menu-item-selected > a");
    ...
    public CreatePrivateGroupAdres creatPublickAdress(){
        ...
        driver.findElement(name).sendKeys("Приватный групповой");
    ...
    public CreatePrivateGroupAdres enterSave(){
        driver.findElement(btnSave).click();
        return this;

    }
    public CreatePrivateGroupAdres addedRole(){
