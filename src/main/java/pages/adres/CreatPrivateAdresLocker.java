...
public class CreatPrivateAdresLocker extends BasePage {
    public CreatPrivateAdresLocker(WebDriver driver) {
        super(driver);
    }
    ...
    public CreatPrivateAdresLocker creatPublickAdress(){
        ...
        driver.findElement(name).sendKeys("Приватный с локером");
    ...
    public CreatPrivateAdresLocker enterSave(){
        driver.findElement(btnSave).click();
        return this;

    }
    public CreatPrivateAdresLocker addedRole(){
