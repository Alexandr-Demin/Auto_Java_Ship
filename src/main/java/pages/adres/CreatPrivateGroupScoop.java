...
public class CreatPrivateGroupScoop extends BasePage {
    public CreatPrivateGroupScoop(WebDriver driver) {
        super(driver);
    }
    ...
    public CreatPrivateGroupScoop creatPublickAdress(){
        ...
        driver.findElement(name).sendKeys("Приватный групповой со скупом");
    ...
    public CreatPrivateGroupScoop enterSave(){
        driver.findElement(btnSave).click();
        return this;

    }
    public CreatPrivateGroupScoop addedRole(){
