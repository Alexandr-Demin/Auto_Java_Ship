...
public class CreatPrivateAdres extends BasePage {
    public CreatPrivateAdres(WebDriver driver) {
        super(driver);
    }
    ...
    public CreatPrivateAdres creatPublickAdress(){
        ...
        driver.findElement(name).sendKeys("Приватный");
    ...
    public CreatPrivateAdres enterSave(){
        driver.findElement(btnSave).click();
        return this;

    }
    public CreatPrivateAdres addedRole(){
        ...
        waitElementWisible(driver.findElement(addedAdmin));
