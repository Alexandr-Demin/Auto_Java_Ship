...
public class CreatePrivateGroupLocker extends BasePage {
    public CreatePrivateGroupLocker(WebDriver driver) {
        super(driver);
    }
    ...
    By addedLogist = By.cssSelector("#root > div > section > section > main > div > div > div.ant-pro-grid-content > div > div > div.ant-tabs-content.ant-tabs-content-animated.ant-tabs-top-content > div.ant-tabs-tabpane.ant-tabs-tabpane-active > div:nth-child(2) > div > div > div > div.antd-pro-components-standard-table-index-standardTable > div > div > div > div > div > div > table > tbody > tr:nth-child(4) > td:nth-child(8) > a:nth-child(3)");
    public CreatePrivateGroupLocker enterAdres(){
        waitElementWisible(driver.findElement(btnAdres));
        driver.findElement(btnAdres).click();
        driver.findElement(btnCreateAdres).click();
        return this;
    }
    public CreatePrivateGroupLocker creatPublickAdress(){
        ...
        driver.findElement(name).sendKeys("Приватный групповой с локером");
        ...
        driver.findElement(lockerRadius).sendKeys("2");
        driver.findElement(RbtnPrivate).click();
        driver.findElement(RbtnLocker).click();
        return this;
    }
    public CreatePrivateGroupLocker enterSave(){
        driver.findElement(btnSave).click();
        return this;

    }
    public CreatePrivateGroupLocker addedRole(){
