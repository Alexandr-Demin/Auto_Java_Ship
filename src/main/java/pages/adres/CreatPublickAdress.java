...
public class CreatPublickAdress extends BasePage{
    public CreatPublickAdress(WebDriver driver) {
        super(driver);
    }
    ...
    public CreatPublickAdress enterAdres(){
    ...
    public CreatPublickAdress enterSave(){
        driver.findElement(btnSave).click();
        return this;
    }
    public CreatPublickAdress addedRole(){
